...
namespace Business.Helpers
{
    ...
    {
        public async static Task<List<ExchangeRate>> GetExchanges()
        {
        ...
        private async static Task<List<ExchangeRate>> FetchCurrencyDataAsync(string url)
        {
        ...
        public static List<ExchangeRate> ParseCurrencyData(string xmlContent)
        {
